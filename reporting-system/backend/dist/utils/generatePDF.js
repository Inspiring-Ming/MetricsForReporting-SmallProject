...
exports.genPDFandHTML = genPDFandHTML;
...
async function genPDFandHTML(data, fileType, id) {
    const folderPath = isFolder("Testing_report");
    switch (fileType.toLocaleLowerCase()) {
        case "pdf": {
            const filePath = path_1.default.join(folderPath, `${id}.pdf`);
        ...
        case "html": {
            const filePath = path_1.default.join(folderPath, `${id}.html`);
            const html = generateHtml(data);
            try {
...
function deleteFile(folderName, fileName) {
    const folderPath = path_1.default.join(process.cwd(), folderName);
    if (!fs_1.default.existsSync(folderPath)) {
        throw (0, http_errors_1.default)(400, "Invalid Folder Path");
    }
    const filePath = path_1.default.join(folderPath, fileName);
    if (!fs_1.default.existsSync(filePath)) {
        throw (0, http_errors_1.default)(400, "Invalid File Name");
    }
    fs_1.default.unlink(filePath, (err) => {
        if (err) {
            throw (0, http_errors_1.default)(500, `Failed removing file: ${err}`);
        }
